...
class Client {
  /**
   * @param {Object} [options] riakpbc connection options
   *                           (host, port, connectTimeout, maxConnections, ...).
   */
  constructor(options) {
    this.client = RiakPBC.createClient(options);
  }
   ...
   * @param  {Object} [options] riakpbc request options.
   ...
   * @param  {Object} [options] riakpbc request options (`type` is the bucket type).
